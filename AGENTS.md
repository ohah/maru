...
- [모바일 플랫폼(iOS·Android)](docs/mobile-platform.md) — [UX(화면·전환)](docs/mobile-ux.md) · [구현 계획](docs/plans/mobile-platform.md)
...
- [에디터 Surface(코드 에디터·git diff 뷰어·포맷/린트·LSP)](docs/editor-surface.md) — 절별 소유: [권장 구조](docs/editor-surface-structure.md)·[도크 소스 컨트롤 뷰](docs/editor-surface-dock.md)·[diff/git·빌드·LSP](docs/editor-surface-tooling.md)·[단계 계획](docs/plans/editor-surface.md)
