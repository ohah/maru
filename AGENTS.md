...
- [에이전트 활동 뷰(에이전트가 읽은 것·실행한 것·이미지 도크)](docs/agent-activity-view.md) — 절별 소유: [이미지 갤러리](docs/agent-image-gallery.md)·[활동 뷰 계획](docs/plans/agent-activity-view.md)·[갤러리 계획](docs/plans/agent-image-gallery.md)·[터미널 마커 프리뷰](docs/agent-image-marker-preview.md)
...
- [세션 컨트롤 플레인(CLI·웹뷰 IPC)](docs/control-plane.md) — 절별 소유: [transport·프로토콜](docs/control-plane-protocol.md)·[보안](docs/control-plane-security.md)·[`browser.*` 코어와 CLI](docs/control-plane-browser.md)·[라이브 배선](docs/control-plane-browser-wiring.md)·[프로토콜 리뷰](docs/control-plane-browser-review.md)·[지속 세션](docs/control-plane-browser-session.md)·[구현 Phase와 검증](docs/plans/control-plane.md)
- [웹 패널 인프라(WKWebView 합성)](docs/web-panel.md) — 절별 소유: [빠진 기능](docs/web-panel-features.md)·[구현 계획](docs/plans/web-panel.md)·[OSR 백엔드 구현 계획](docs/plans/web-osr-backend.md)
