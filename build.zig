...
pub fn build(b: *std.Build) void {
    ...
    if (target.result.os.tag == .macos) {
        for ([_]std.builtin.OptimizeMode{ .Debug, .ReleaseFast }) |composition_optimize| {
            ...
            run_candidate_baseline_preparation_product_tests.addArg("--maru-expect-tests=9");
            ...
            run_candidate_prerequisite_product_tests.addArg("--maru-expect-tests=9");
            ...
            run_candidate_publication_product_tests.addArg("--maru-expect-tests=5");
