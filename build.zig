...
pub fn build(b: *std.Build) void {
    ...
    if (target.result.os.tag == .macos) {
        ...
        inline for ([_][]const u8{ "empty", "loading", "retained-list", "font-specimen", "partial-scroll", "partial-group-scroll", "scrollbar", "sticky-at-rest", "sticky-pinned", "sticky-pushed", "detail-loading", "detail-ready", "detail-stale", "detail-unavailable", "sidebar-status-strip", "editor-gutter", "editor-scrolled", "editor-font-large", "editor-hazard", "editor-wide-glyph", "editor-wrap", "editor-hscroll", "editor-folded", "editor-wrap-scrolled", "editor-wrap-stale-scroll", "editor-real-file", "editor-selection", "editor-diff-selection", "editor-diff", "editor-diff-scrolled", "context-menu-checked", "context-menu-unchecked", "scm-rows", "scm-row-hover", "scm-repo-hover", "scm-scrolled", "scm-commit-edit", "file-tree-rows", "file-tree-row-hover", "sort-toggle-hover", "sort-toggle-pressed" }) |scenario| {
