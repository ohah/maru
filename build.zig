...
pub fn build(b: *std.Build) void {
    ...
    if (target.result.os.tag == .macos) {
        ...
        inline for ([_][]const u8{ "empty", "loading", "retained-list", "font-specimen", "partial-scroll", "partial-group-scroll", "scrollbar", "sticky-at-rest", "sticky-pinned", "sticky-pushed", "detail-loading", "detail-ready", "detail-stale", "detail-unavailable" }) |scenario| {
