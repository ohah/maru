...
/// ① 의 시험 수(inbox 2 + dispatch 8 + registry 2 + title_gate 2 + ring_receiver 8 + ring_producer 2 + input_map 2 + dialog_table 2 + 입구 파일의 `test {}` 블록 1). 시험을 더하거나 빼면 같이 고친다 —
/// 조용히 빠지는 것을 러너가 잡는다.
const pure_test_count = 29;
