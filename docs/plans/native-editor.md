...
- **N1.5 — git diff 본문(읽기 전용, ../native-editor-ui.md §7).** 좌우 배치·세로 동기·추가/삭제 배경(`diffFromTheme`)·
  ...
  **이 문서의 첫 제품 가치가 여기서 나온다**([editor-surface.md](../editor-surface.md) §1: "첫 제품 가치는 에이전트가
  ...
  ([editor-surface.md](../editor-surface-dock.md) §3.5) 이 슬라이스로 **검토 흐름 전체가 네이티브로 닫힌다.**
...
- **N5 — 미니맵·overview 스트립.** 미니맵(§6 — 전 문서 대상, lexer 층만, L2 폭 합 캐시 직접 읽기, 색 블록 quad)과
  ...
  [editor-surface.md](../editor-surface-dock.md) §3.5 소유라 이 순서 밖이고, diff **본문**은 N1.5로 앞당겼다.
...
아니라 [editor-surface.md](../editor-surface-tooling.md) §8.2가 소유하며 N4와 독립적으로 진행할 수 있다.
