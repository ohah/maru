...
| W2 | **`main.zig` Windows 컴파일** — unix domain socket(`:1107`)은 "인스턴스 없음"으로 graceful 폴백. named pipe 이식은 아니다. **선행 결정: `publishBrowserResult`의 파일 권한**(`:978` `fromMode(0o600)` → Windows ACL, 계약 §8) | **결정 대기** |
