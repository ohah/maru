...
**이관은 진행 중이다** — 빌드 소스를 문자열로 재던 145자리 중 **56자리**가 뷰로 갔고 89자리가
남았다. 옮긴 결은 셋이다: 「이 스텝이 있는가」 31 · 매달기 13 · 실행 인자 8 · 필터 4.
남은 것의 결은 이렇다: 파일 경로 13 · 제어 흐름과 선언 11 · 실행·인자 8 · 환경변수 8 ·
박힌 셸·정규식 5 · 매달기 5. **제어 흐름·선언과 박힌 셸·정규식 16자리는 안 옮긴다** — 그건 빌드
