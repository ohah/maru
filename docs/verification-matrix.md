...
product exec와 real PTY/MRSH client gate로 검증했다. restore activation precommit 11행과 postcommit 4행도 actual same-PID process와 real PTY로 검증했다. 최대치 근처 multi-runtime 제품 restore,
