...
```text
(865, 40)  #1E2430 → #4F5663      편집기 막대 안
(865,300)  #1E2430 → #1E2430      막대 아래(막대는 y 0..155)
...
| **W8.3** | **에디터 표면** — ⒜ 본문·gutter(**완료**, §2m.21) ⒝ 배경·스크롤바 — 파이프라인이 아니라 **셰이더**가 필요했다(둥근 모서리·반투명, **완료** §2m.22) ⒞ 입력 라우팅(다음). 선행이던 셰이퍼 상한 둘은 §2m.19 로 걷었다 | W8.2 |
