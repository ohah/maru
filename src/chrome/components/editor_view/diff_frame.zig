...
pub const Side = struct {
    ...
    /// 현재 줄 강조·활성 줄 번호·짝 괄호 상자(§5.1b) — 단일 편집기만(비교 뷰는 기본값 = 없음).
    line_highlight: frame.LineHighlight = .none,
    ...
    diag_lines: []const frame.diagnostic.LineMark = &.{},
...
pub fn buildSide(
    ...
    return frame.build(.{
        ...
        .sticky = side.sticky,
        .line_highlight = side.line_highlight,
