...
const Table = struct {
    ...
    fp_remote_change_unsupported: [:0]const u8,
...
const en: Table = .{
    ...
    .fp_remote_change_unsupported = "Creating and deleting on a remote is not supported yet. Renaming works.",
...
const ko: Table = .{
    ...
    .fp_remote_change_unsupported = "원격에서 만들기·삭제는 아직 지원하지 않습니다. 이름 변경은 됩니다.",
