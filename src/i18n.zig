...
const Table = struct {
    ...
    cfg_editor_render_line_highlight: [:0]const u8,
    cfg_editor_match_brackets: [:0]const u8,
    cfg_editor_render_whitespace: [:0]const u8,
    cfg_editor_guides_indentation: [:0]const u8,
    cfg_editor_guides_highlight_active_indentation: [:0]const u8,
    cfg_editor_bracket_pair_colorization: [:0]const u8,
...
const en: Table = .{
    ...
    .cfg_editor_render_line_highlight = "Highlight the line at the cursor (none, gutter, line, all)",
    .cfg_editor_match_brackets = "Highlight matching brackets (never, near, always)",
    .cfg_editor_render_whitespace = "Show whitespace characters (none, boundary, selection, trailing, all)",
    .cfg_editor_guides_indentation = "Draw indentation guides",
    .cfg_editor_guides_highlight_active_indentation = "Highlight the indentation guide of the block at the cursor",
    .cfg_editor_bracket_pair_colorization = "Color matching bracket pairs by nesting level",
    ...
    .cfg_term = "$TERM value",
    .cfg_term_program = "$TERM_PROGRAM value (default \"maru\"; changing it makes apps think you are another terminal)",
...
const ko: Table = .{
    ...
    .cfg_editor_render_line_highlight = "커서가 선 줄을 강조 (none · gutter · line · all)",
    .cfg_editor_match_brackets = "짝 괄호를 강조 (never · near · always)",
    .cfg_editor_render_whitespace = "공백·탭을 기호로 보인다 (none · boundary · selection · trailing · all)",
    .cfg_editor_guides_indentation = "들여쓰기 안내선을 그린다",
    .cfg_editor_guides_highlight_active_indentation = "커서가 든 블록의 안내선을 밝힌다",
    .cfg_editor_bracket_pair_colorization = "짝 괄호를 중첩 단계마다 다른 색으로 칠한다",
    ...
    .cfg_term = "$TERM 값",
    .cfg_term_program = "$TERM_PROGRAM 값 (기본 \"maru\" — 바꾸면 앱이 다른 터미널로 오인한다)",
