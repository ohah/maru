...
pub const Table = struct {
    ...
    sd_detail_loading: [:0]const u8,
    sd_detail_ready: [:0]const u8,
    sd_detail_stale: [:0]const u8,
    sd_detail_unavailable: [:0]const u8,
    sd_action_records: [:0]const u8,
    sd_role_user: [:0]const u8,
    sd_role_assistant: [:0]const u8,
...
pub const en: Table = .{
    ...
    .sd_detail_loading = "Analyzing session",
    .sd_detail_ready = "Recent conversation",
    .sd_detail_stale = "The session source changed",
    .sd_detail_unavailable = "Cannot open the session",
    .sd_action_records = "{0} tool/permission records",
    .sd_role_user = "User",
    .sd_role_assistant = "Agent",
    ...
    .cfg_chrome_theme = "Chrome design theme",
...
pub const ko: Table = .{
    ...
    .sd_scope_all = "전체",
    .sd_search = "세션 검색",
    .sd_detail_loading = "세션 분석 중",
    .sd_detail_ready = "최근 대화",
    .sd_detail_stale = "세션 원본이 변경되었습니다",
    .sd_detail_unavailable = "세션을 열 수 없습니다",
    .sd_action_records = "도구/권한 관련 기록 {0}건",
    .sd_role_user = "사용자",
    .sd_role_assistant = "에이전트",
    ...
    .cfg_chrome_theme = "chrome 디자인 테마",
