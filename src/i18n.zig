...
pub const Table = struct {
    ...
    mob_servers_empty_hint: [:0]const u8,
    mob_server_no_fingerprint: [:0]const u8,
...
pub const en: Table = .{
    ...
    .mob_servers_empty_hint = "Start with ssh.server.1.host in config",
    .mob_server_no_fingerprint = "No fingerprint - cannot connect",
...
pub const ko: Table = .{
    ...
    .mob_servers_empty_hint = "config 의 ssh.server.1.host 부터 적는다",
    .mob_server_no_fingerprint = "지문이 없다 — 접속할 수 없다",
    .mob_appearance = "모양",
