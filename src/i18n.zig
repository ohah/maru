...
const Table = struct {
    ...
    editor_untitled_name_is_dir: [:0]const u8,
...
const en: Table = .{
    ...
    .editor_untitled_name_is_dir = "That name is a folder. Choose a different name.",
...
const ko: Table = .{
    ...
    .editor_untitled_name_is_dir = "그 이름은 폴더입니다. 다른 이름을 쓰세요",
