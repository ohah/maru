...
const Table = struct {
    ...
    cfg_sidebar_agent_transcript_hook: [:0]const u8,
...
const en: Table = .{
    ...
    .cfg_sidebar_agent_transcript_hook = "Install the claude statusline hook for agent transcripts",
...
const ko: Table = .{
    ...
    .cfg_sidebar_agent_transcript_hook = "에이전트 대화 표시용 claude 상태줄 훅 설치",
