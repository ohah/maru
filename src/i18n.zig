...
const Table = struct {
    ...
    fp_remote_open_unsupported: [:0]const u8,
...
const en: Table = .{
    ...
    .fp_remote_open_unsupported = "Opening remote files is not supported yet.",
...
const ko: Table = .{
    ...
    .fp_remote_open_unsupported = "원격 파일 열기는 아직 지원하지 않습니다.",
