...
pub const Table = struct {
    ...
    ad_summary: [:0]const u8,
    ad_summary_sub: [:0]const u8,
    ad_summary_sub_more: [:0]const u8,
...
pub const en: Table = .{
    ...
    .ad_summary = "{0} messages · {1} · {2}",
    .ad_summary_sub = "{0} messages · {1} · {2} · {3} subagents",
    .ad_summary_sub_more = "{0} messages · {1} · {2} · {3}+ subagents",
...
pub const ko: Table = .{
    ...
    .ad_summary = "메시지 {0}개 · {1} · {2}",
    .ad_summary_sub = "메시지 {0}개 · {1} · {2} · 서브에이전트 {3}",
    .ad_summary_sub_more = "메시지 {0}개 · {1} · {2} · 서브에이전트 {3}+",
