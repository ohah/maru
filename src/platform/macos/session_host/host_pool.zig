...
pub fn HostPool(comptime Adapter: type) type {
    return struct {
        ...
        entries: std.AutoHashMapUnmanaged(u128, *Adapter) = .empty,
        ...
        pub fn addOwned(self: *Self, host_id: u128, adapter: *Adapter) !void {
            ...
            try self.entries.put(self.allocator, host_id, adapter);
        }

        pub fn get(self: *Self, host_id: u128) ?*Adapter {
            return self.entries.get(host_id);
        }
