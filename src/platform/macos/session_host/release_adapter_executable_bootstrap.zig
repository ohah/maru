...
fn bindCommand(command: contract.Command, trusted: context_mod.Context) Error!Bound {
    ...
    return switch (command) {
        ...
        .prepare_profile_candidate => |value| .{
            .command = .{ .prepare_profile_candidate = .{
                .repo = value.repo,
                .tag = value.tag,
                .test_uuid = value.test_uuid,
                .dmg = value.dmg,
                ...
                .zig_size = value.zig_size,
                .zig_sha256 = value.zig_sha256,
                .predecessor_workspace = value.predecessor_workspace,
                .upgrade_workspace = value.upgrade_workspace,
                .durable_preparation = value.durable_preparation,
                .timing_output = value.timing_output,
            } },
            .cli = try bindValues(value.repo, value.tag, value.github_cli, value.github_cli_sha256, trusted),
        },
        ...
        .resume_candidate_publication => |value| .{
