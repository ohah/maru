...
pub const agent_session_archive_detail = @import("session/agent_session_archive_detail.zig"); // archive tab 최근 turn·action 요약 순수 투영
...
pub const content_menu = @import("session/content_menu.zig"); // 파일 본문 우클릭 메뉴 항목 정책(file-panel.md §2.6)
