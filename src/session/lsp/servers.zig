...
pub fn forGrammar(g: language.Grammar) ?Server {
    return switch (g) {
        ...
        .typescript => .{ .exe = "typescript-language-server", .args = &stdio, .language_id = "typescript", .install = "npm i -g typescript-language-server typescript" },
        .tsx => .{ .exe = "typescript-language-server", .args = &stdio, .language_id = "typescriptreact", .install = "npm i -g typescript-language-server typescript" },
        .javascript => .{ .exe = "typescript-language-server", .args = &stdio, .language_id = "javascript", .install = "npm i -g typescript-language-server typescript" },
