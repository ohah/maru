...
pub const inventory = [_]Proof{
    ...
    .{ .path = "src/platform/macos/app_session.zig", .count = 2, .digest_hex = "981f6fbbe5aa1193943cc2fb524af29f937ebf3d6c9b8f32495bc4aefe5ff0d9" },
    ...
    .{ .path = "src/i18n.zig", .count = 1, .digest_hex = "bd5905fd5b11da5cf3702300eb7d3f1962efed41a5d141a29ef51ae920f9beaa" },
};
