...
pub const inventory = [_]Proof{
    ...
    .{ .path = "src/platform/macos/app_session.zig", .count = 2, .digest_hex = "9ada23ca65efb598a773e114f776f6d26cd50dd0e24e9c23bc33c3f42dfca406" },
    ...
    .{ .path = "src/i18n.zig", .count = 1, .digest_hex = "f9913ff235552067b65ecd2f6dff5553bf06232a581f4daa0049042affbf2168" },
};
