...
const inventory = [_]Entry{
    ...
    .{ .path = "src/platform/macos/app_session.zig", .count = 47 },
...
const header_total = 242; // +2: 편집기 판정자의 큰 문서 픽스처 · +2: 인라인 위젯 행 Lab 픽스처(S1.5) · +1: e4d4 메타데이터 대기 진단 · +2: .frametime 단계 요약(§10.6) · +3: 코어 락 경합 진단(§13·§13.7)
