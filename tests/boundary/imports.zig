...
test "CR3a-2c2b3b B3b-S inventories every public Client receiver before policy closure" {
    ...
    const guarded = [_]ClientGuardProof{
        ...
        .{ .receiver = "poison", .funnel = "poison", .gate = "beginPublicMutation", .pre_gate_self_fields = &.{ "exactAllocatorCallbackOwner", "prepared_request_execution_lease_addr", "capturePreparedExecutionPoison" } },
