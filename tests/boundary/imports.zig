...
test "CR3a-2c2b3b declaration baseline admits only the doc-first owner delta" {
    ...
    const cases = [_]struct {
        ...
        .{
            ...
            // current Client declaration inventory를 고정한다.
            .baseline_digest = .{ 0x35, 0xba, 0x3f, 0x0b, 0xa8, 0x06, 0xaf, 0x44, 0xaf, 0x3f, 0x02, 0xe6, 0xac, 0xf4, 0xcf, 0x5c, 0xea, 0x45, 0x32, 0xe4, 0xfc, 0x4d, 0x98, 0xde, 0xff, 0x22, 0xf2, 0x42, 0xcf, 0x6d, 0xa3, 0x11 },
