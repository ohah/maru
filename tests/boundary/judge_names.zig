...
const slice_named = [_][]const u8{
    ...
    "tests/session_host_cr3b_r1_boundary.zig",
    "tests/session_host_cr3b_r2a_boundary.zig",
    "tests/session_host_cr3b_r2b_boundary.zig",
    "tests/session_host_cr3b_r2c_boundary.zig",
    "tests/session_host_cr3b_r3_boundary.zig",
    ...
    "tests/session_host_cr6e_c3c_sample_set_boundary.zig",
    "tests/session_host_cr6f_boundary.zig",
    "tests/session_host_cr6f_idle_soak_boundary.zig",
    "tests/session_host_e2a_boundary.zig",
    "tests/session_host_e2b_boundary.zig",
    "tests/session_host_e2c_boundary.zig",
    "tests/session_host_e3a_boundary.zig",
    "tests/session_host_e3b_boundary.zig",
    "tests/session_host_e3c_boundary.zig",
    "tests/session_host_f3c0_codec_sentinel.zig",
    "tests/session_host_f3c0_remote_sentinel.zig",
    "tests/session_host_f3c0_sentinel.zig",
    "tests/session_host_f3c1_sentinel.zig",
    "tests/session_host_f3c2_sentinel.zig",
    "tests/session_host_f3d_sentinel.zig",
    "tests/session_host_f3e_sentinel.zig",
    "tests/session_host_kernel_cwd_k1_boundary.zig",
    "tests/session_host_kernel_cwd_k2_boundary.zig",
    "tests/session_host_kernel_cwd_k3_boundary.zig",
    "tests/session_host_p4_r3_screen_inbox_boundary.zig",
    "tests/session_host_release_adapter_p5d_candidate_gate.zig",
    "tests/session_host_release_adapter_p5d_candidate_product_boundary.zig",
    "tests/session_host_release_adapter_p5d_runner.zig",
    "tests/session_host_release_adapter_p5d_workspace.zig",
