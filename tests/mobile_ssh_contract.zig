...
test "헤더와 브리지의 인자 폭이 전부 같다" {
    const names = .{
        ...
        "maru_mobile_ssh_eof",                  "maru_mobile_ssh_keepalive",
        "maru_mobile_ssh_out_ptr",              "maru_mobile_ssh_out_len",
        "maru_mobile_ssh_out_consume",          "maru_mobile_ssh_screen_ptr",
        "maru_mobile_ssh_screen_len",           "maru_mobile_ssh_screen_consume",
        "maru_mobile_ssh_host_key_fingerprint", "maru_mobile_ssh_accept_host_key",
        "maru_mobile_ssh_disconnect_reason",    "maru_mobile_ssh_disconnect_description",
        "maru_mobile_ssh_banner",               "maru_mobile_ssh_exit_status",
        "maru_mobile_ssh_exit_signal",          "maru_mobile_ssh_last_error",
        "maru_mobile_ssh_clear_error",          "maru_mobile_ssh_load_key",
        "maru_mobile_ssh_last_load_error",      "maru_mobile_ssh_rekeys",
        "maru_mobile_ssh_generate_key",         "maru_mobile_ssh_public_key_line",
        "maru_mobile_ssh_password",             "maru_mobile_ssh_private_key_pem",
