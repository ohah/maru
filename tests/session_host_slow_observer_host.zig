...
const Probe = struct {
    ...
    fn afterTurn(
        ...
        if (self.sendPending(telemetry, pty_output_bytes, output_wake, child_exit, observation)) |action| return action;
        ...
        return self.sendPending(telemetry, pty_output_bytes, output_wake, child_exit, observation) orelse
            .continue_serving;
    }
};
